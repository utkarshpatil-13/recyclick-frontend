  ...
  return (
    <>
        <div className='relative h-fit'>
            ...
            <div className="relative z-10 w-[80vw] mx-auto p-20">
                <div className='my-10 flex py-10 rounded-3xl items-center gap-10'>
                    <div>
                    ...
                    <div>
                      <img src="https://bookmyjunk.com/src/img/certificate.png" className='w-[55vw] p-7 rounded-3xl border-2 border-[rgb(63,185,140)]'  alt="" />
                    </div>
                </div>
            </div>
        </div>
